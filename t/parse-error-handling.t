...
h6 {color: black }',
    ...
    stylesheet => {input => '@media print and (width: 21cm) { @page { margin: 3cm; @top-center { content: "Page " counter(page); }}}',
                   ast => ["at-rule" => {"media-list" => ["media-query" => ["media" => "print", "media-expr" => {"property" => "width", "expr" => ["length" => 21e0]}]],
                                         "media-rules" => ["at-rule" => {"declarations" => {"margin-top" => {"expr" => ["length" => 3e0]},
                                                                                            "margin-right" => {"expr" => ["length" => 3e0]},
                                                                                            "margin-bottom" => {"expr" => ["length" => 3e0]},
                                                                                            "margin-left" => {"expr" => ["length" => 3e0]},
                                                                                            "\@top-center" => {"margin-box" => {"box-vpos" => "top",
                                                                                                                                "box-center" => "center"},
                                                                                                               "declarations" => {"content" => {"expr" => ["string" => "Page ", "counter" => ["identifier" => "page"]]}}}},
                                                                         "\@" => "page"}],
                                         "\@" => "media"}],
    },
