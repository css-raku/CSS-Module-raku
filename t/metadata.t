...
is-deeply $css1-prop<border>, {:box, :children["border-top", "border-right", "border-bottom", "border-left"], :!inherit, :synopsis("'border-width' || 'border-style' || 'border-color'")}, 'css1 border';
is-deeply $css1-prop<border-style>, {:box, :children[<border-top-style border-right-style border-bottom-style border-left-style>], :!inherit, :synopsis("[ none | dotted | dashed | solid | double | groove | ridge | inset | outset ]\{1,4}") }, 'css1 border-style';
