...
is-deeply $CSS::Module::CSS3::Metadata::property<border-style>, {:box, :children[<border-top-style border-right-style border-bottom-style border-left-style>], :default["none none none none", [{:keyw<none>}, {:keyw<none>}, {:keyw<none>}, {:keyw<none>},]], :!inherit, :synopsis("[ none | hidden | dotted | dashed | solid | double | groove | ridge | inset | outset ]\{1,4}") }, 'border-style';
