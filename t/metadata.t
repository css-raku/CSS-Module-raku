...
is-deeply $css1-prop<border>, {:box, :edges["border-top", "border-right", "border-bottom", "border-left"], :children["border-color", "border-style", "border-width"], :!inherit, :synopsis("'border-width' || 'border-style' || 'border-color'")}, 'css1 border';
...
is-deeply $css21-prop<border>, {:box, :children["border-color", "border-style", "border-width"], :edges["border-top", "border-right", "border-bottom", "border-left"], :!inherit, :synopsis("[ 'border-width' || 'border-style' || 'border-color' ]")}, 'css21 border';
...
is-deeply $css3-prop<border>, {:box, :children["border-color", "border-style", "border-width"], :edges["border-top", "border-right", "border-bottom", "border-left"], :!inherit, :synopsis("[ 'border-width' || 'border-style' || 'border-color' ]")}, 'css3 border';
