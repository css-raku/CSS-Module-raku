...
for "012AF", "012AFc" {
    ...
    ok  $_ ~~ /^<CSS::Module::Snapshot2026::unicode>$/, "css4 unicode: $_";
}
...
for '' {
    ...
    ok  $_ ~~ /^<CSS::Module::Snapshot2026::nonascii>$/, "non-ascii css3: $_";
}
...
my CSS::Module $css4  = CSS::Module::Snapshot2026.module;
