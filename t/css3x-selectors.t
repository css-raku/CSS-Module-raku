...
for (
    ...
    selector   => {input => 'div *:not(p)',
                   ast => ["simple-selector" => ["element-name" => "div"], "simple-selector" => ["wildcard" => "*", "pseudo" => {"function" => {"ident" => "not", "args" => ["type-selector" => {"element-name" => "p"}]}}]],
    },
...
# :first-child is a pseudo-class, :first-line is a pseudo-element
    ...
    selector   => {input => '*', ast => ["simple-selector" => ["wildcard" => "*"]],},
