...
for (
    ...
    selector   => {input => 'div *:not(p)',
                   ast => ["simple-selector" => [qname => {"element-name" => "div"}], "simple-selector" => [universal => {"element-name" => "*"}, "pseudo" => {"function" => {"ident" => "not", "args" => ["type-selector" => {"element-name" => "p"}]}}]],
    },
    selector   => {input => 'input:not([type="file"])',
                   ast => ["simple-selector" => [qname => {"element-name" => "input"}, "pseudo" => {"function" => {"ident" => "not", "args" => ["attrib" => {"ident" => "type", "attribute-selector" => "=", "string" => "file"}]}}]],
    },
# :first-child is a pseudo-class, :first-line is a pseudo-element
    selector   => {input => 'li:not(.pingback) .comment-content p:first-child:first-line',
                   ast => ["simple-selector" => [
                               qname => {"element-name" => "li"},
                               "pseudo" => {"function" => {"ident" => "not",
                                                           "args" => ["class" => "pingback"]}}],
                           "simple-selector" => ["class" => "comment-content"],
                           "simple-selector" => [qname => {"element-name" => "p"},
                                                 "pseudo" => {"class" => "first-child"},
                                                 "pseudo" => {"element" => "first-line"}]],
    },
    selector   => {input => 'body:not(.home) h2 + p:first-letter',
                   ast => ["simple-selector" => [qname => {"element-name" => "body"}, "pseudo" => {"function" => {"ident" => "not", "args" => ["class" => "home"]}}],
    ...
    selector =>   {input => 'h2:not(:first-of-type):not(:last-of-type)',
                   ast => ["simple-selector" => [qname => {"element-name" => "h2"},
    ...
    selector   => {input => '*', ast => ["simple-selector" => [universal => {"element-name" => "*"}]],},
    selector => {input => 'foo|h1',
                 ast => ["simple-selector" => [qname => {"namespace-prefix" => {namespace => "foo"}, "element-name" => "h1"}]],
    },
    selector => {input => 'foo|*',
                 ast => ["simple-selector" => [universal => {"namespace-prefix" => {namespace => "foo"},
                                               "element-name" => "*"}]],
    },
    selector => {input => '|h1',
                 ast => ["simple-selector" => [qname => {"namespace-prefix" => {no-namespace => True},
                                                         "element-name" => "h1"}]],
    },
    selector => {input => '*|h1',
                 ast => ["simple-selector" => [qname => {"namespace-prefix" => {"any-namespace" => "*"},
                                               "element-name" => "h1"}]],
                 
    },
    # attributes
    selector => {input => 'span[hello="Cleveland"][goodbye="Columbus"]',
                 ast => ["simple-selector" => [qname => {"element-name" => "span"},
    ...
    selector => {input => 'object[type^="image/"]',
                 ast => ["simple-selector" => [qname => {"element-name" => "object"},
                                              "attrib" => {"ident" => "type", "attribute-selector" => "^=", "string" => "image/"}]],
    },
    # regular functions
    selector => {input => 'foo:lang(en)',
                 ast => ["simple-selector" => [qname => {"element-name" => "foo"},
    ...
    selector => {input => 'td:nth-child(3)',
                 ast => ["simple-selector" => [qname => {"element-name" => "td"},
                                               "pseudo" => {"function" => {"ident" => "nth-child",
                                                                           "args" => {"b" => 3}}}]],
    },
    ...
    selector => {input => 'tr:nth-child( 3n + 1 )',
                 ast => ["simple-selector" => [qname => {"element-name" => "tr"}, "pseudo" => {"function" => {"ident" => "nth-child", "args" => {"a" => 3, "b" => 1}}}]],
    },
    selector => {input => 'tr:nth-child( +3n - 2 )',
                 ast => ["simple-selector" => [qname => {"element-name" => "tr"}, "pseudo" => {"function" => {"ident" => "nth-child", "args" => {"a" => 3, "b" => -2}}}]]
    },
    selector => {input => 'tr:nth-child( -n+ 6 )',
                 ast => ["simple-selector" => [qname => {"element-name" => "tr"}, "pseudo" => {"function" => {"ident" => "nth-child", "args" => {"b" => 6, "a" => -1}}}]],
    },
    selector => {input => 'tr:nth-child( +6 )',
                 ast => ["simple-selector" => [qname => {"element-name" => "tr"}, "pseudo" => {"function" => {"ident" => "nth-child", "args" => {"b" => 6}}}]],
    },
    # white-space - invalid
