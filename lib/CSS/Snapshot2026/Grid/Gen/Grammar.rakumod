...
#| grid: <'grid-template'> |! <'grid-template'=.'grid-template-rows'> / [ auto-flow && dense? ] <'grid-auto-columns'>? |! [ auto-flow && dense? ] <'grid-auto-rows'>? / <'grid-template'=.'grid-template-columns'>
...
rule css-val-grid { :i <css-val-grid-template=.css-val-grid-template-rows> <op("/")> [["auto-flow" & <keyw> :my $*A;<!{
    ...
    $*B++
}>]** 2] <css-val-grid-auto-columns> ?  || [["auto-flow" & <keyw> :my $*C;<!{
    $*C++
}>|| [dense & <keyw>] ? :my $*D;<!{
    $*D++
}>]** 2] <css-val-grid-auto-rows> ? <op("/")> <css-val-grid-template=.css-val-grid-template-columns>  || <css-val-grid-template>  }
#| grid-area: <grid-line> [ / <grid-line> ]{0,3}
rule decl:sym<grid-area> { :i ("grid-area") ":" <val(/<css-val-grid-area> /, &?ROUTINE.WHY)>}
rule css-val-grid-area { :i <grid-line> [<op("/")> <grid-line> ] ** 0..3  }
#| grid-auto-columns: <track-size>+
rule decl:sym<grid-auto-columns> { :i ("grid-auto-columns") ":" <val(/<css-val-grid-auto-columns> /, &?ROUTINE.WHY)>}
rule css-val-grid-auto-columns { :i <track-size> + }
#| grid-auto-flow: [ row | column ] || dense
rule decl:sym<grid-auto-flow> { :i ("grid-auto-flow") ":" <val(/<css-val-grid-auto-flow> /, &?ROUTINE.WHY)>}
rule css-val-grid-auto-flow { :i [[[row | column ]& <keyw> ] :my $*A;<!{
    $*A++
}>|| dense & <keyw> :my $*B;<!{
    $*B++
}>]+ }
#| grid-auto-rows: <track-size>+
rule decl:sym<grid-auto-rows> { :i ("grid-auto-rows") ":" <val(/<css-val-grid-auto-rows> /, &?ROUTINE.WHY)>}
rule css-val-grid-auto-rows { :i <track-size> + }
#| grid-column: <grid-line> [ / <grid-line> ]?
rule decl:sym<grid-column> { :i ("grid-column") ":" <val(/<css-val-grid-column> /, &?ROUTINE.WHY)>}
rule css-val-grid-column { :i <grid-line> [<op("/")> <grid-line> ] ?  }
#| grid-column-end: <grid-line>
rule decl:sym<grid-column-end> { :i ("grid-column-end") ":" <val(/<css-val-grid-column-end> /, &?ROUTINE.WHY)>}
rule css-val-grid-column-end { :i <grid-line> }
#| grid-column-start: <grid-line>
rule decl:sym<grid-column-start> { :i ("grid-column-start") ":" <val(/<css-val-grid-column-start> /, &?ROUTINE.WHY)>}
rule css-val-grid-column-start { :i <grid-line> }
#| grid-row: <grid-line> [ / <grid-line> ]?
rule decl:sym<grid-row> { :i ("grid-row") ":" <val(/<css-val-grid-row> /, &?ROUTINE.WHY)>}
rule css-val-grid-row { :i <grid-line> [<op("/")> <grid-line> ] ?  }
#| grid-row-end: <grid-line>
rule decl:sym<grid-row-end> { :i ("grid-row-end") ":" <val(/<css-val-grid-row-end> /, &?ROUTINE.WHY)>}
rule css-val-grid-row-end { :i <grid-line> }
...
rule decl:sym<grid-template-areas> { :i ("grid-template-areas") ":" <val(/<css-val-grid-template-areas> /, &?ROUTINE.WHY)>}
rule css-val-grid-template-areas { :i none & <keyw> || <string> +  }
#| grid-template-columns: none | <track-list> | <auto-track-list>
rule decl:sym<grid-template-columns> { :i ("grid-template-columns") ":" <val(/<css-val-grid-template-columns> /, &?ROUTINE.WHY)>}
rule css-val-grid-template-columns { :i none & <keyw> || <track-list> || <auto-track-list>  }
#| grid-template-rows: none | <track-list> | <auto-track-list>
rule decl:sym<grid-template-rows> { :i ("grid-template-rows") ":" <val(/<css-val-grid-template-rows> /, &?ROUTINE.WHY)>}
rule css-val-grid-template-rows { :i none & <keyw> || <track-list> || <auto-track-list>  }
