...
rule decl:sym<color-interpolation> { :i ("color-interpolation") ":" <val(/<prop-val-color-interpolation> /, &?ROUTINE.WHY)>}
rule prop-val-color-interpolation { :i [auto | sRGB | linearRGB ]& <keyw>  }
#| color-rendering: auto | optimizeSpeed | optimizeQuality
rule decl:sym<color-rendering> { :i ("color-rendering") ":" <val(/<prop-val-color-rendering> /, &?ROUTINE.WHY)>}
...
rule decl:sym<fill-rule> { :i ("fill-rule") ":" <val(/<prop-val-fill-rule> /, &?ROUTINE.WHY)>}
...
rule prop-val-marker { :i [see & <keyw> ] [individual & <keyw> ] [properties & <keyw> ]  }
#| marker-end: none | <url>
...
rule decl:sym<pointer-events> { :i ("pointer-events") ":" <val(/<prop-val-pointer-events> /, &?ROUTINE.WHY)>}
...
rule decl:sym<shape-rendering> { :i ("shape-rendering") ":" <val(/<prop-val-shape-rendering> /, &?ROUTINE.WHY)>}
...
#| stroke: <paint>
rule decl:sym<stroke> { :i (stroke) ":" <val(/<prop-val-stroke> /, &?ROUTINE.WHY)>}
...
rule prop-val-stroke-dasharray { :i [none & <keyw> ] || <dasharray>  }
#| <dasharray> = [ <length-percentage> | <number> ]#
rule dasharray { :i [<length-percentage> || <number> ] +% <op(",")>? }
#| stroke-dashoffset: <length-percentage>
rule decl:sym<stroke-dashoffset> { :i ("stroke-dashoffset") ":" <val(/<prop-val-stroke-dashoffset> /, &?ROUTINE.WHY)>}
rule prop-val-stroke-dashoffset { :i <length-percentage> }
#| stroke-linecap: butt | round | square
rule decl:sym<stroke-linecap> { :i ("stroke-linecap") ":" <val(/<prop-val-stroke-linecap> /, &?ROUTINE.WHY)>}
rule prop-val-stroke-linecap { :i [butt | round | square ]& <keyw>  }
#| stroke-linejoin: miter | round | bevel
rule decl:sym<stroke-linejoin> { :i ("stroke-linejoin") ":" <val(/<prop-val-stroke-linejoin> /, &?ROUTINE.WHY)>}
rule prop-val-stroke-linejoin { :i [miter | round | bevel ]& <keyw>  }
#| stroke-miterlimit: <number>
rule decl:sym<stroke-miterlimit> { :i ("stroke-miterlimit") ":" <val(/<prop-val-stroke-miterlimit> /, &?ROUTINE.WHY)>}
rule prop-val-stroke-miterlimit { :i <number> }
#| stroke-opacity: <alpha-value>
rule decl:sym<stroke-opacity> { :i ("stroke-opacity") ":" <val(/<prop-val-stroke-opacity> /, &?ROUTINE.WHY)>}
rule prop-val-stroke-opacity { :i <alpha-value> }
#| stroke-width: <length-percentage>
rule decl:sym<stroke-width> { :i ("stroke-width") ":" <val(/<prop-val-stroke-width> /, &?ROUTINE.WHY)>}
rule prop-val-stroke-width { :i <length-percentage> }
#| text-anchor: start | middle | end
rule decl:sym<text-anchor> { :i ("text-anchor") ":" <val(/<prop-val-text-anchor> /, &?ROUTINE.WHY)>}
...
rule decl:sym<text-rendering> { :i ("text-rendering") ":" <val(/<prop-val-text-rendering> /, &?ROUTINE.WHY)>}
...
rule decl:sym<vector-effect> { :i ("vector-effect") ":" <val(/<prop-val-vector-effect> /, &?ROUTINE.WHY)>}
