...
rule decl:sym<background-clip> { :i ("background-clip") ":" <val(/<css-val-background-clip> /, &?ROUTINE.WHY)>}
rule css-val-background-clip { :i <visual-box> +% <op(",")>? }
...
rule css-val-background-image { :i <bg-image> +% <op(",")>? }
#| <bg-image> = <image> | none
...
rule decl:sym<background-size> { :i ("background-size") ":" <val(/<css-val-background-size> /, &?ROUTINE.WHY)>}
rule css-val-background-size { :i <bg-size> +% <op(",")>? }
...
rule decl:sym<border-bottom-left-radius> { :i ("border-bottom-left-radius") ":" <val(/<css-val-border-bottom-left-radius> /, &?ROUTINE.WHY)>}
rule css-val-border-bottom-left-radius { :i <length-percentage> ** 1..2 }
#| border-bottom-right-radius: <length-percentage [0,∞]>{1,2}
rule decl:sym<border-bottom-right-radius> { :i ("border-bottom-right-radius") ":" <val(/<css-val-border-bottom-right-radius> /, &?ROUTINE.WHY)>}
rule css-val-border-bottom-right-radius { :i <length-percentage> ** 1..2 }
...
rule css-val-border-color { :i <color> ** 1..4 }
...
rule decl:sym<border-image-outset> { :i ("border-image-outset") ":" <val(/<css-val-border-image-outset> /, &?ROUTINE.WHY)>}
rule css-val-border-image-outset { :i [<length> || <number> ] ** 1..4 }
#| border-image-repeat: [ stretch | repeat | round | space ]{1,2}
rule decl:sym<border-image-repeat> { :i ("border-image-repeat") ":" <val(/<css-val-border-image-repeat> /, &?ROUTINE.WHY)>}
rule css-val-border-image-repeat { :i [[stretch | repeat | round | space ]& <keyw> ] ** 1..2 }
...
rule decl:sym<border-image-width> { :i ("border-image-width") ":" <val(/<css-val-border-image-width> /, &?ROUTINE.WHY)>}
rule css-val-border-image-width { :i [<length-percentage> || <number> || auto & <keyw> ] ** 1..4 }
...
rule css-val-border-style { :i <line-style> ** 1..4 }
...
rule css-val-border-width { :i <line-width> ** 1..4 }
