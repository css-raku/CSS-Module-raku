...
rule decl:sym<mask-border-repeat> { :i ("mask-border-repeat") ":" <val(/<prop-val-mask-border-repeat> /, &?ROUTINE.WHY)>}
rule prop-val-mask-border-repeat { :i <prop-val-border-image-repeat> }
#| mask-border-slice: <.'border-image-slice'>
rule decl:sym<mask-border-slice> { :i ("mask-border-slice") ":" <val(/<prop-val-mask-border-slice> /, &?ROUTINE.WHY)>}
rule prop-val-mask-border-slice { :i <prop-val-border-image-slice> }
#| mask-border-source: <.'border-image-source'>
rule decl:sym<mask-border-source> { :i ("mask-border-source") ":" <val(/<prop-val-mask-border-source> /, &?ROUTINE.WHY)>}
rule prop-val-mask-border-source { :i <prop-val-border-image-source> }
#| mask-border-width: <.'border-image-width'>
rule decl:sym<mask-border-width> { :i ("mask-border-width") ":" <val(/<prop-val-mask-border-width> /, &?ROUTINE.WHY)>}
