...
rule polygon { :i "polygon(" [<css-val-fill-rule> ? [:!r [round & <keyw> <length> ] ","]? [<length-percentage> <length-percentage> ] +% ","?  || <usage(&?ROUTINE.WHY)> ] ")" }
#| path( <'fill-rule'>? , <string> )
rule path { :i "path(" [[:!r <css-val-fill-rule> ","]? <string>  || <usage(&?ROUTINE.WHY)> ] ")" }
