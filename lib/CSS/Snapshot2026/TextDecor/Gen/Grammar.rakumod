...
rule prop-val-text-decoration { :i [<prop-val-text-decoration-line> :my $*A;<!{
    $*A++
}>|| <prop-val-text-decoration-style> :my $*B;<!{
    $*B++
}>|| <prop-val-text-decoration-color> :my $*C;<!{
    $*C++
}>]+ }
#| text-decoration-color: <color>
rule decl:sym<text-decoration-color> { :i ("text-decoration-color") ":" <val(/<prop-val-text-decoration-color> /, &?ROUTINE.WHY)>}
...
rule decl:sym<text-decoration-style> { :i ("text-decoration-style") ":" <val(/<prop-val-text-decoration-style> /, &?ROUTINE.WHY)>}
rule prop-val-text-decoration-style { :i [solid | double | dotted | dashed | wavy ]& <keyw>  }
#| text-emphasis: <'text-emphasis-style'> || <'text-emphasis-color'>
rule decl:sym<text-emphasis> { :i ("text-emphasis") ":" <val(/<prop-val-text-emphasis> /, &?ROUTINE.WHY)>}
rule prop-val-text-emphasis { :i [<prop-val-text-emphasis-style> :my $*A;<!{
    $*A++
}>|| <prop-val-text-emphasis-color> :my $*B;<!{
    $*B++
}>]+ }
#| text-emphasis-color: <color>
rule decl:sym<text-emphasis-color> { :i ("text-emphasis-color") ":" <val(/<prop-val-text-emphasis-color> /, &?ROUTINE.WHY)>}
rule prop-val-text-emphasis-color { :i <color> }
#| text-emphasis-position: [ over | under ] && [ right | left ]?
rule decl:sym<text-emphasis-position> { :i ("text-emphasis-position") ":" <val(/<prop-val-text-emphasis-position> /, &?ROUTINE.WHY)>}
rule prop-val-text-emphasis-position { :i [[[over | under ]& <keyw> ] :my $*A;<!{
    $*A++
