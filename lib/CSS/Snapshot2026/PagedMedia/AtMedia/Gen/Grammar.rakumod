unit grammar CSS::Snapshot2026::PagedMedia::AtMedia::Gen::Grammar;
#| @media <media-query-list> <declarations>
rule decl:sym<@media> { "\@"<at-rule=.at-rule-media>}
rule at-rule-media { (:i media) <media-query-list> <declarations> }
#| <rule-list> = <declarations>
rule rule-list { :i <declarations> }
...
rule general-enclosed { :i [<function-token> <any-value> ? <op(")")> ] || [<op("(")> <any-value> ?<op(")")> ] }
