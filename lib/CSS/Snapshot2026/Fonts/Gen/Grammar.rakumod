...
rule prop-val-font { :i [[[<prop-val-font-style> :my $*A;<!{
    $*A++
}>|| <prop-val-font-variant=.font-variant-css2> :my $*B;<!{
    $*B++
}>|| <prop-val-font-weight> :my $*C;<!{
    $*C++
}>|| <prop-val-font-stretch> :my $*D;<!{
    $*D++
}>]+] ? <prop-val-font-size> [<op("/")> <prop-val-line-height> ] ? <prop-val-font-family> +% <op(",")>? ] || <system-font-family-name>  }
...
rule prop-val-font-stretch { :i <font-width-css3> }
...
rule prop-val-font-family { :i [<generic-font-family> || <font-family-name> ] +% <op(",")>? }
...
rule decl:sym<font-kerning> { :i ("font-kerning") ":" <val(/<prop-val-font-kerning> /, &?ROUTINE.WHY)>}
...
rule decl:sym<font-optical-sizing> { :i ("font-optical-sizing") ":" <val(/<prop-val-font-optical-sizing> /, &?ROUTINE.WHY)>}
rule prop-val-font-optical-sizing { :i [auto | none ]& <keyw>  }
#| font-palette: normal | light | dark | <palette-identifier> | <palette-mix()>
rule decl:sym<font-palette> { :i ("font-palette") ":" <val(/<prop-val-font-palette> /, &?ROUTINE.WHY)>}
rule prop-val-font-palette { :i [normal | light | dark ]& <keyw>  || <palette-identifier> || <palette-mix>  }
...
rule decl:sym<font-size-adjust> { :i ("font-size-adjust") ":" <val(/<prop-val-font-size-adjust> /, &?ROUTINE.WHY)>}
rule prop-val-font-size-adjust { :i [none & <keyw> ] || <number>  }
...
rule prop-val-font-style { :i [normal | italic | left | right | oblique ]& <keyw>  <angle> ?  }
#| font-synthesis: none | [ weight || style || small-caps || position]
rule decl:sym<font-synthesis> { :i ("font-synthesis") ":" <val(/<prop-val-font-synthesis> /, &?ROUTINE.WHY)>}
...
rule decl:sym<font-synthesis-position> { :i ("font-synthesis-position") ":" <val(/<prop-val-font-synthesis-position> /, &?ROUTINE.WHY)>}
rule prop-val-font-synthesis-position { :i [auto | none ]& <keyw>  }
#| font-synthesis-small-caps: auto | none
rule decl:sym<font-synthesis-small-caps> { :i ("font-synthesis-small-caps") ":" <val(/<prop-val-font-synthesis-small-caps> /, &?ROUTINE.WHY)>}
rule prop-val-font-synthesis-small-caps { :i [auto | none ]& <keyw>  }
#| font-synthesis-style: auto | none | oblique-only
rule decl:sym<font-synthesis-style> { :i ("font-synthesis-style") ":" <val(/<prop-val-font-synthesis-style> /, &?ROUTINE.WHY)>}
rule prop-val-font-synthesis-style { :i [auto | none | "oblique-only" ]& <keyw>  }
#| font-synthesis-weight: auto | none
rule decl:sym<font-synthesis-weight> { :i ("font-synthesis-weight") ":" <val(/<prop-val-font-synthesis-weight> /, &?ROUTINE.WHY)>}
rule prop-val-font-synthesis-weight { :i [auto | none ]& <keyw>  }
...
rule prop-val-font-variant { :i [normal | none ]& <keyw>  || [[[[<common-lig-values> :my $*B;<!{
    $*B++
...
rule decl:sym<font-variant-alternates> { :i ("font-variant-alternates") ":" <val(/<prop-val-font-variant-alternates> /, &?ROUTINE.WHY)>}
...
rule decl:sym<font-variant-caps> { :i ("font-variant-caps") ":" <val(/<prop-val-font-variant-caps> /, &?ROUTINE.WHY)>}
...
rule decl:sym<font-variant-east-asian> { :i ("font-variant-east-asian") ":" <val(/<prop-val-font-variant-east-asian> /, &?ROUTINE.WHY)>}
...
rule decl:sym<font-variant-emoji> { :i ("font-variant-emoji") ":" <val(/<prop-val-font-variant-emoji> /, &?ROUTINE.WHY)>}
rule prop-val-font-variant-emoji { :i [normal | text | emoji | unicode ]& <keyw>  }
#| font-variant-ligatures: normal | none | [ <common-lig-values> || <discretionary-lig-values> || <historical-lig-values> || <contextual-alt-values> ]
rule decl:sym<font-variant-ligatures> { :i ("font-variant-ligatures") ":" <val(/<prop-val-font-variant-ligatures> /, &?ROUTINE.WHY)>}
...
rule decl:sym<font-variant-numeric> { :i ("font-variant-numeric") ":" <val(/<prop-val-font-variant-numeric> /, &?ROUTINE.WHY)>}
...
rule decl:sym<font-variant-position> { :i ("font-variant-position") ":" <val(/<prop-val-font-variant-position> /, &?ROUTINE.WHY)>}
...
rule prop-val-font-variation-settings { :i [normal & <keyw> ] || [<opentype-tag> <number> ] +% <op(",")>?  }
#| font-weight: <font-weight-absolute> | bolder | lighter
rule decl:sym<font-weight> { :i ("font-weight") ":" <val(/<prop-val-font-weight> /, &?ROUTINE.WHY)>}
rule prop-val-font-weight { :i <font-weight-absolute> || [bolder | lighter ]& <keyw>   }
...
rule prop-val-font-width { :i [normal & <keyw> ] || <percentage> || ["ultra-condensed" | "extra-condensed" | condensed | "semi-condensed" | "semi-expanded" | expanded | "extra-expanded" | "ultra-expanded" ]& <keyw>   }