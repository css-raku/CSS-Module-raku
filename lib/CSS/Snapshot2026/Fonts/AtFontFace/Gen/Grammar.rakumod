...
rule decl:sym<ascent-override> { :i ("ascent-override") ":" <val(/<css-val-ascent-override> /, &?ROUTINE.WHY)>}
rule css-val-ascent-override { :i normal & <keyw> || <percentage>  }
#| descent-override: normal | <percentage [0,∞]>
rule decl:sym<descent-override> { :i ("descent-override") ":" <val(/<css-val-descent-override> /, &?ROUTINE.WHY)>}
rule css-val-descent-override { :i normal & <keyw> || <percentage>  }
#| font-display: auto | block | swap | fallback | optional
rule decl:sym<font-display> { :i ("font-display") ":" <val(/<css-val-font-display> /, &?ROUTINE.WHY)>}
rule css-val-font-display { :i [auto | block | swap | fallback | optional ]& <keyw>  }
...
rule decl:sym<font-named-instance> { :i ("font-named-instance") ":" <val(/<css-val-font-named-instance> /, &?ROUTINE.WHY)>}
rule css-val-font-named-instance { :i auto & <keyw> || <string>  }
...
rule css-val-font-width { :i auto & <keyw> || <css-val-font-width> ** 1..2  }
