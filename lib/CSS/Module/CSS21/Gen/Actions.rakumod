unit class CSS::Module::CSS21::Gen::Actions;
method delta ($/) {
    make $.build.rule($/)
}
method direction ($/) {
...
method expr-border-top-color ($/) {
    make $.build.list($/)
}
method expr-border-right-color ($/) {
    make $.build.list($/)
}
method expr-border-bottom-color ($/) {
    make $.build.list($/)
}
method expr-border-left-color ($/) {
    make $.build.list($/)
}
