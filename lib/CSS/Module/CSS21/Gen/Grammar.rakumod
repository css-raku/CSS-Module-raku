...
rule prop-val-background-position { :i [[<percentage> || <length> || <align> ] [<percentage> || <length> || <valign> ] ? ] || [[<align> :my $*A; <!{
    $*A++
}>| <valign> :my $*B; <!{
    $*B++
}>]+]  }
...
rule decl:sym<border-collapse> { :i ("border-collapse") ":" <val(/<expr=.prop-val-border-collapse> /, &?ROUTINE.WHY)>}
...
rule decl:sym<border-spacing> { :i ("border-spacing") ":" <val(/<expr=.prop-val-border-spacing> /, &?ROUTINE.WHY)>}
...
rule decl:sym<bottom> { :i (bottom) ":" <val(/<expr=.prop-val-bottom> /, &?ROUTINE.WHY)>}
rule prop-val-bottom { :i <length> || <percentage> || auto & <keyw>   }
#| caption-side: top | bottom
rule decl:sym<caption-side> { :i ("caption-side") ":" <val(/<expr=.prop-val-caption-side> /, &?ROUTINE.WHY)>}
...
rule decl:sym<counter-increment> { :i ("counter-increment") ":" <val(/<expr=.prop-val-counter-increment> /, &?ROUTINE.WHY)>}
rule prop-val-counter-increment { :i none & <keyw>  || [<identifier> <integer> ? ] +  }
#| counter-reset: none | [ <identifier> <integer>? ]+
rule decl:sym<counter-reset> { :i ("counter-reset") ":" <val(/<expr=.prop-val-counter-reset> /, &?ROUTINE.WHY)>}
rule prop-val-counter-reset { :i none & <keyw>  || [<identifier> <integer> ? ] +  }
#| cue-after: <uri> | none
...
rule decl:sym<cursor> { :i (cursor) ":" <val(/<expr=.prop-val-cursor> /, &?ROUTINE.WHY)>}
...
rule decl:sym<max-width> { :i ("max-width") ":" <val(/<expr=.prop-val-max-width> /, &?ROUTINE.WHY)>}
rule prop-val-max-width { :i <length> || <percentage> || none & <keyw>   }
#| min-height: <length> | <percentage>
rule decl:sym<min-height> { :i ("min-height") ":" <val(/<expr=.prop-val-min-height> /, &?ROUTINE.WHY)>}
...
rule prop-val-opacity { :i <number> }
#| orphans: <integer>
rule decl:sym<orphans> { :i (orphans) ":" <val(/<expr=.prop-val-orphans> /, &?ROUTINE.WHY)>}
rule prop-val-orphans { :i <integer> }
#| outline-color: <color> | invert
rule decl:sym<outline-color> { :i ("outline-color") ":" <val(/<expr=.prop-val-outline-color> /, &?ROUTINE.WHY)>}
rule prop-val-outline-color { :i <color> || invert & <keyw>   }
#| outline-style: [ none | hidden | dotted | dashed | solid | double | groove | ridge | inset | outset ]
rule decl:sym<outline-style> { :i ("outline-style") ":" <val(/<expr=.prop-val-outline-style> /, &?ROUTINE.WHY)>}
rule prop-val-outline-style { :i [[none | hidden | dotted | dashed | solid | double | groove | ridge | inset | outset ]& <keyw> ] }
#| outline-width: thin | medium | thick | <length>
rule decl:sym<outline-width> { :i ("outline-width") ":" <val(/<expr=.prop-val-outline-width> /, &?ROUTINE.WHY)>}
rule prop-val-outline-width { :i [thin | medium | thick ]& <keyw>  || <length>  }
#| outline: [ 'outline-color' || 'outline-style' || 'outline-width' ]
rule decl:sym<outline> { :i (outline) ":" <val(/<expr=.prop-val-outline> /, &?ROUTINE.WHY)>}
...
rule decl:sym<page-break-inside> { :i ("page-break-inside") ":" <val(/<expr=.prop-val-page-break-inside> /, &?ROUTINE.WHY)>}
...
rule decl:sym<quotes> { :i (quotes) ":" <val(/<expr=.prop-val-quotes> /, &?ROUTINE.WHY)>}
...
rule decl:sym<right> { :i (right) ":" <val(/<expr=.prop-val-right> /, &?ROUTINE.WHY)>}
...
rule decl:sym<table-layout> { :i ("table-layout") ":" <val(/<expr=.prop-val-table-layout> /, &?ROUTINE.WHY)>}
...
rule decl:sym<unicode-bidi> { :i ("unicode-bidi") ":" <val(/<expr=.prop-val-unicode-bidi> /, &?ROUTINE.WHY)>}
...
#| widows: <integer>
rule decl:sym<widows> { :i (widows) ":" <val(/<expr=.prop-val-widows> /, &?ROUTINE.WHY)>}
