...
grammar CSS::Language::CSS21:ver<20110607.000> 
   ...
   # - border-top-color|border-right-color|border-bottom-color|border-left-color: <color> | transparent | inherit
    ...
    token cue-after {:i <uri> | none & <ident> }
    rule decl:sym<cue-after> {:i (cue\-after) ':'  [ <cue-after> | inherit || <any-args> ] }

    # - cue-before: <uri> | none | inherit
    token cue-before {:i <uri> | none & <ident> }
   ...
   # - outline: [ 'outline-color' || 'outline-style' || 'outline-width' ] | inherit
    ...
    rule decl:sym<voice-family> {:i (voice\-family) ':' [ [ [ [ <specific-voice> | <generic-voice> ] ] ',' ]* [ [ <specific-voice> | <generic-voice> ] ] | <inherit> || <any-args> ] }
